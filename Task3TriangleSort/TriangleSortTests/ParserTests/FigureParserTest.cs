...
namespace TriangleSortTests
{
    ...
    public class FigureParserTest
    {
        ...
        public void GetName_WithTriangleData_ShouldReturnTriangleName(string args, string expected)
        {
            //arrange
        ...
        public void GetSides_WithTriangleData_ShouldReturnTriangleSides(string args, double[] expected)
        {
            //arrange
            var mockFigureParser = new Mock<FigureParser>(MockBehavior.Default, args);
        ...
        [Fact]
        public void GetName_ShouldThrowArgumentExpeption_When_NoTriangleData()
        {
            //arrange
        ...
        public void GetSides_ShouldThrowArgumentOutOfRangeExp_When_SidesBelowZero(string args)
        {
            //arrange
            var mockFigureParser = new Mock<FigureParser>(MockBehavior.Default, args);
        ...
        public void GetSides_ShouldThrowFormatExeption_When_NonNumericSides(string args)
        {
            //arrange
            var mockFigureParser = new Mock<FigureParser>(MockBehavior.Default, args);
